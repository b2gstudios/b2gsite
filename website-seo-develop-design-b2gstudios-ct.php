        ...
        <article class="seperator">
	       ...
	       <ul class="filter">
	        ...
	        <div id="masonry" class="portfolio-entries columns4 clearfix">
                ...
                <div class="masonry_item portfolio-entry web">
                    <div class="imgoverlay">
                        <a href="professional-websites-b2gstudios-ct.php" class="loadcontent" rel="Baby_News"><img src="files/images/portfolio/baby_news_thumb.png" alt="Work 08"/></a>
                    </div>
                    <div class="portfolio-meta">
	                    <h5><a href="professional-websites-b2gstudios-ct.php" class="loadcontent" rel="Baby_News"><strong>Baby News</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
                </div>
            </div><!-- END #masonry -->	
