...
<META NAME="Description" CONTENT="Need a Premium Website?. We are b2gStudios. A Professional, Creative & Unique Web Studio. Offering Premium Responsive Website Design and Development. Now Available: 'White Glove' Web Solutions.">';
...
<link rel="stylesheet" type="text/css" href="404/style.css" media="all" />
...
<!--You can change this text to any type of error you need (401, 403, 404, 500, 503, etc...) -->  
            <h2 class="text_1">
              <span class="error_text_span">404 error</span>
            </h2>
            ...
            <div class="text_3">
                <p class="reasons_big custom_font">There's a lot of reasons why this page is <span class="error_type">404</span>.</p>
                <p class="reasons_small custom_font">Don't waste your time enjoying the look of it</p>
            </div>
            ...
            <div class="buttons_1">
                <a href="#" class="home" title="Back to home">Home</a>
                <a href="#" class="contact" title="Contact us">Contact</a>
            </div>
            
            <div class="seach_1">
                <form id="search_form" action="http://b2gstudios.com/b2gwebsitesct/POST">
                  <input type="text" class="input_search" value="Search on site" onblur="if(this.value=='') {this.value='Search on site';}" onclick="if(this.value=='Search on site') {this.value='';}"  />
