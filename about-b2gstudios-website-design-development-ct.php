...
<section id="pagetitle">
    <div class="pagetitle_inner wrapperoverlay">
        <h2><strong>About Us</strong><span class="tagline">We build only the highest quality premium websites. </span></h2>
    </div>
</section>
...
<section id="main">
    <div class="main_inner wrapper clearfix">
        ...
        <article>
            ...
            <h2 class="page-description"><i>Our websites increase sales by generating traffic. Find out why we are the recommended premium website developers.</i></h2>
            
            <div class="seperator-section"></div>
            
	<div class="column one_third">
        
        <img title="Custom Wordpress eCommerce solution for a small business" src="files/images/ecommerce-solution.png" alt="Premium Ecommerce Web site with Wordpress CMS">
